...
{
	GLint points = 50;
	GLdouble delTheta = (2.0 * 3.14) / (GLdouble)points;
	GLdouble theta = 0.0;
...
void Tree_Model_Two(){
	...
	glPushMatrix();
	glTranslatef(1150, 408, 0);
	circle(5);
	glPopMatrix();

	glPushMatrix();
	glTranslatef(1155, 406, 0);
	circle(5);
	glPopMatrix();

	glPushMatrix();
	glTranslatef(1159, 408, 0);
	circle(5);
	glPopMatrix();

	glPushMatrix();
	glTranslatef(1154, 405, 0);
	circle(5);
	glPopMatrix();
...
void dheu()
{
	...
	renderBitmapString(45, 95, 0, GLUT_BITMAP_HELVETICA_18, "SURGICAL STRIKE");
	glFlush();
...
void megh()
{
	...
	glBegin(GL_LINES);
	glColor3f(1.0, 1.0, 0);
	glVertex2i(115+40, 640);
	glVertex2i(115+30, 350);
	glEnd();
	glFlush();	
	glColor3f(0, 0.0, 1.0);
	drawCircle(115+80, 570, 25);
	glBegin(GL_LINES);
	glColor3f(0.0, 0.0,1.0);
	glVertex2i(115 + 80, 570);
	glVertex2i(115 + 70, 500);
	glEnd();
	glBegin(GL_LINES);
	glColor3f(0.0, 0.0,1.0);
	glVertex2i(115 + 70, 500);
	glVertex2i(115 + 30, 520);
	glEnd();
	glBegin(GL_LINES);
	glColor3f(0.0, 0.0,1.0);
	glVertex2i(115 + 70, 500);
	glVertex2i(115 + 30,480);
	glEnd();
	glBegin(GL_LINES);
	glColor3f(0.0, 0.0, 1.0);
	glVertex2i(115 + 80, 570-25);
	glVertex2i(115 + 30, 570-25);
	glEnd();
	glColor3f(1.0, 0.0, 0.0);
	glRectf(175, 695, 190, 705);//propeller stand
	glRectf(105, 700, 245, 707);
...
{
	glColor3f(1.0, 1.0, 1.0);
	drawCircle(10, 750, 2.9);
	drawCircle(55, 550, 2.9);
	drawCircle(100, 600, 2.9);
	drawCircle(155,425, 2.9);
	drawCircle(200,490, 2.9);
	drawCircle(255, 700, 2.9);
	drawCircle(300, 650, 2.9);
	drawCircle(355, 450, 2.9);
	drawCircle(400, 505, 2.9);
	drawCircle(455,604, 2.9);
	drawCircle(500, 444, 2.9);
	drawCircle(555, 510, 2.9);
	drawCircle(600, 713, 2.9);
	drawCircle(655, 623, 2.9);
	drawCircle(700, 415, 2.9);
	drawCircle(755, 543, 2.9);
	drawCircle(800, 669, 2.9);
	drawCircle(855, 484, 2.9);
	drawCircle(900, 723, 2.9);
	drawCircle(955, 555, 2.9);
	drawCircle(1000, 631, 2.9);
	drawCircle(1055, 423, 2.9);
	drawCircle(1100, 745, 2.9);
	drawCircle(1155, 567, 2.9);
	drawCircle(1200, 690, 2.9);
	drawCircle(1255, 750, 2.9);
...
void Display1(void)
{
	...
	glLoadIdentity();
	glPushMatrix();
	glTranslatef(45.0, 670.0f, 1);
	glRotatef(angle, 0.0f, 0.0f, 1.0f);
	angle = angle - rate;
	glTranslatef(-45.0f, -670.0f, -1.0f);
	windmill();
	glPopMatrix();
	glFlush();
	hill_big2();
